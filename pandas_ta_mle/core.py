...
from pandas_ta_mle import Category, Imports, version
from pandas_ta_mle.candles.cdl_pattern import ALL_PATTERNS
from pandas_ta_mle.candles import *
from pandas_ta_mle.cycles import *
from pandas_ta_mle.momentum import *
from pandas_ta_mle.overlap import *
from pandas_ta_mle.performance import *
from pandas_ta_mle.statistics import *
from pandas_ta_mle.trend import *
from pandas_ta_mle.volatility import *
from pandas_ta_mle.volume import *
from pandas_ta_mle.utils import *
...
class Strategy:
    ...
    ta: List | None = field(default_factory=list)  # Required.
...
class AnalysisIndicators(BasePandasObject):
    ...
    def _get_column(self, series) -> pd.Series:
        ...
        # Ok.  So it's a str.
            ...
            if series in df.columns:
                ...
                NOT_FOUND = f"[X] Oops! It's {series not in df.columns}, the series '{series}' was not found in {cols}"
    ...
    def percent_return(self, length=None, cumulative=False, percent=False, offset=None, **kwargs):
        print('beginning percent_return')
        close = self._get_column(kwargs.pop("close", "close"))
