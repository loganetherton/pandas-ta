...
from pandas_ta_mle.utils import get_drift, get_offset, verify_series
...
def vidya(close, length=None, drift=None, offset=None, **kwargs):
    ...
    def _cmo(source: Series, n:int , d: int):
        ...
        For some reason: from pandas_ta_mle.momentum import cmo causes
        pandas_ta.momentum.coppock to not be able to import it's
        wma like from pandas_ta_mle.overlap import wma?
